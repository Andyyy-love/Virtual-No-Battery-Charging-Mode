...
struct charger_ops {
	...
	int (*set_pd_adapter)(struct charger_device *dev, int *pd_adapter);
	...
	int (*get_property)(struct charger_device *dev,
			    enum charger_property prop,
			    union charger_propval *val);
	int (*set_vreg_ft)(struct charger_device *dev, bool temp);
};
...
extern int charger_dev_get_property(struct charger_device *dev,
				    enum charger_property prop,
				    union charger_propval *val);
extern int charger_dev_set_vreg_ft(
	struct charger_device *charger_dev, bool temp);

/* For buck1 FPWM */
extern int charger_dev_enable_hidden_mode(struct charger_device *dev, bool en);

extern int charger_dev_set_pd_adapter(struct charger_device *dev, int *pd_adapter);
