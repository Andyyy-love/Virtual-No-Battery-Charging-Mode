...
#define ITERM 930000
#define RECHARGE_OFFSET 200000
#define RECHARGE_VOL 4330000
...
#define UNKNOWN_CHARGER_CURRENT     420000
...
#define APPLE_0_5A_CHARGER_CURRENT		500000
#define APPLE_1_0A_CHARGER_CURRENT		1000000
#define APPLE_2_1A_CHARGER_CURRENT		2000000
#define APPLE_2_4A_CHARGER_CURRENT		2000000
...
#define MIN_CHARGE_TEMP_PLUS_X_DEGREE	60
#define MAX_CHARGE_TEMP  500
#define MAX_CHARGE_TEMP_MINUS_X_DEGREE	470
...
struct charger_custom_data {
	...
	int pd_max_charger_voltage;
	int min_charger_voltage;
	int vbus_sw_ovp_voltage;

	int unknown_charger_current;
	...
	int lowtemp_charger_current;
	int lowtemp_charger_input_current;
	int hightemp_charger_current;
	int hightemp_charger_input_current;
	int apple_0_5a_charger_current;
	int apple_1_0a_charger_current;
	int apple_2_1a_charger_current;
	int apple_2_4a_charger_current;
	...
	int jeita_temp_above_t4_recharge;
	int jeita_temp_t3_to_t4_recharge;
	int jeita_temp_t2_to_t3_recharge;
	int jeita_temp_t1_to_t2_recharge;
	int jeita_temp_t0_to_t1_recharge;
	int jeita_temp_below_t0_recharge;
...
enum {
    NONSTAND_APPLE_12W = 2400,
    NONSTAND_APPLE_10W = 2100,
    NONSTAND_APPLE_5W = 1000,
    NONSTAND_SAMSUNG_10W = 2000,
    NONSTAND_DEFAULT = 500,
    NORMAL_ADAPTER = 0,
};
...
struct mtk_charger {
	...
	int cmd_pp;
	struct notifier_block sysfs_notifier;
	bool curr_flag;
	/* enable boot volt*/
...
extern int get_pd_adapter(int pd_type);
...
extern int battery_set_battery_cv(int *cv);
extern int battery_show_battery_cv( int *cv);
extern int maintenance_set(int *dynamic_cv, int *dynamic_soc_rechg, int *dynamic_gas_cv);
extern int maintenance20_set(int *dynamic20_cv, int *dynamic_soc_rechg, int *dynamic20_gas_cv);
/* functions for other */
extern int mtk_chg_enable_vbus_ovp(bool enable);
extern bool is_kernel_power_off_charging_tp(void);
